...
class TeacherSelectRoutesScreen extends StatefulWidget {
  static const String name = '/teacher-select-routes';

  const TeacherSelectRoutesScreen({super.key});

  @override
  State<TeacherSelectRoutesScreen> createState() => _TeacherSelectRoutesScreenState();
}

class _TeacherSelectRoutesScreenState extends State<TeacherSelectRoutesScreen> {
  final List<String> routes = ['Route 1', 'Route 2', 'Route 3', 'Route 4'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const AppBarLogout(title: 'Select a Route'),
      body: ListView.builder(
        itemCount: routes.length,
        itemBuilder: (context, index) {
          return Card(
